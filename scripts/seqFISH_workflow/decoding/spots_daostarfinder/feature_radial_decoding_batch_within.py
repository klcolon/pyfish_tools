...
exp_dir                      = "250203_mb_161genes" #name of experimental directory
user                         = "Lex" #name of user
num_rounds                   = 4     #number of rounds
first_radius                 = 1.4   #first search radii
second_radius                = 2   #second search radii
...
desired_fdr                  = 0.09  #desired FDR (0-1). Could set to None if you would like to filter yourself.
